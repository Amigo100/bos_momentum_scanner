...
functions as the weekly scanner (imported from core.scanner).
...
DAILY_PORTFOLIO_FILE = TRADES_DIR / "daily_portfolio.csv"
DAILY_SIGNALS_FILE = TRADES_DIR / "daily_signals.json"
WEEKLY_PORTFOLIO_FILE = TRADES_DIR / "portfolio.csv"
DAILY_BACKUP_DIR = TRADES_DIR / "daily_portfolio_backups"
...
def calculate_bos_daily(
    ...
    try:
        ...
        # HMA of HL2 — imported from core.scanner
        hma = calculate_hma(hl2, hma_length)

        # Pivots on HMA — imported from core.scanner
...
def _send_daily_sell_notifications(sell_signals: List[DailyTrade]) -> None:
    ...
    try:
        ...
        logger.warning("distribution.notifications not available — skipping sell notifications")
        return
