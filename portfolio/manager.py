...
# Path constants from config.output_paths (via config)
try:
    from config import (
    ...
    from scanner.sterling_indicators import check_profit_lock
except ImportError:
...
BACKUP_DIR = PORTFOLIO_BACKUP_DIR

# Ensure output directories exist
PORTFOLIO_FILE.parent.mkdir(parents=True, exist_ok=True)
BACKUP_DIR.mkdir(parents=True, exist_ok=True)

# Old files for migration (legacy trades/ location)
OLD_OPEN_POSITIONS = BASE_DIR / "trades" / "open_positions.csv"
OLD_TRADE_LOG = BASE_DIR / "trades" / "trade_log.csv"
...
class EquityTracker:
    ...
    def __init__(self, starting_per_position: float = None, equity_file: Path = None):
        ...
        self.equity_file = equity_file or EQUITY_CURVE_FILE
