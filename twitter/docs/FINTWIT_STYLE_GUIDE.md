...
### 5. TECHNICAL_ANALYSIS (Chart Updates)
...
Once we break through, which we're very well on track to do, we're shooting towards $8-10.
```
...
That double confirmed square called this entire rally since the $4 region...
