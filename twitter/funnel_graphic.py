...
try:
    from config import DEFAULT_UNIVERSE_SIZE
except ImportError:
    DEFAULT_UNIVERSE_SIZE = 1817
...
# Output paths
from config import CHARTS_DIR, SIGNALS_FILE
...
def load_signals_data(signals_path: Optional[Path] = None) -> Dict:
    ...
    if signals_path.exists():
        try:
            ...
            return {
                'universe': stats.get('tickers_loaded', DEFAULT_UNIVERSE_SIZE),
...
def get_sample_data() -> Dict:
    ...
    return {
        'universe': DEFAULT_UNIVERSE_SIZE,
        'volatility': 485,
        'institutional': 48,
        'theme': 17,
        'final': 6,
